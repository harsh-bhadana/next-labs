...
*   **[Animated View Transitions](app/interactive-ui-lab/view-transitions/page.tsx)**: Programmatic transition orchestration with React 19 `useViewTransition` hook.
*   **[Drag-and-Drop Kanban](app/interactive-ui-lab/kanban/page.tsx)**: 🚀 **New** High-fidelity board with optimistic reordering and Framer Motion animations.
...
*   **[Zero-State Server CRUD](app/performance-lab/server-crud/page.tsx)**: A CRUD application with 0kb client-side state, powered entirely by Server Actions and `revalidatePath()`.
...
*   **[BFF Stock Ticker](app/the-rendering/bff-stocks/page.tsx)**: The Backend-for-Frontend pattern using `useSyncExternalStore` for real-time aggregated feeds.
